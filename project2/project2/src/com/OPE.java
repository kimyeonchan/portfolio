...
public class OPE {
	...
	public OPE() {
		...
		this.inRange = new ValueRange(new BigInteger("2").pow(24).negate(),
				new BigInteger("2").pow(28));
		this.outRange = new ValueRange(new BigInteger("2").pow(28).negate(),
